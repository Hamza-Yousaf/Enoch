      ...
      <HeaderWebsite>
        <div className="enochweb-header-coookiePolicy">
          ...
          <div className="enochweb-header-tag">
            ...
            <div id="cookie-hd-title3" className="enochwen-cookiePolicy-headline cookiePolicy-headline-dBlock">
        ...
        <div className="enochweb-container">
          <div className="cookie-policy-block">
              ...
              <ul>
                ...
                <li>
                  ...
                  <a href="/copyright-policy">
                    <button className="cookietablink active">Copyright policy</button>
                  </a>
                </li>
                <li>
                  {" "}
            ...
            <div className="cookie-policy-block-right">
              <div id="Copyright" className="cookietabcontent cookie-display">
...
export default trackWindowScroll(CopyrightPolicy);
