...
const AllUsers = () => {
    ...
    return (
        <div id="AllUsers" className="tabcontent">
            {isData ? <div className="usermanage">
                <div className="usermanage__userWrap">
                    <div className="usermanage__userWrapDetail">
                        ...
                        {/* <div className="usermanage__userWrap__subTitle">All Users</div> */}
                    </div>
                    ...
                    <div className="magicSearchFull">
                        <input type="text" id="myHouse" name="myHouse" className="magicSearchFull_community__search" placeholder="type here..." />
                        <img src="/images/search-field-icon.svg" className="magicSearchFull__icon" alt="" />
                        <div className="magicSearch__Boxlist magicSearch-display-none ul-box" id="resultAllUsers">
                        ...
                        <table className="table">
                            ...
                            <tbody>
                                ...
                                <tr className="communitytableList__user__tr">
                                    ...
                                    <td className="communitytableList__joinDate">20/11/2021</td>
                                    <td className="communitytableList__status text-purple">Moderator</td>
                                    <td className="communitytableList__showDetail">
                                        <div className="dropdown ">
                                            <div className="cursor" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <div className="toggle-color"></div>
                                ...
                                <tr className="communitytableList__user__tr">
                                    ...
                                    <td className="communitytableList__joinDate">20/11/2021</td>
                                    <td className="communitytableList__status text-orange">Muted</td>
                                    <td className="communitytableList__showDetail">
                                        <div className="dropdown">
                                            <div className="cursor" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <div className="toggle-color"></div>
            ...
            </div> : <Empty heading='All Users' msg='No Users/Community name'  imgSrc='AllUsers_icon.svg'/>}
