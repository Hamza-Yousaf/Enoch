...
const Muted = () => {
    ...
    return (
        <div id="Muted" className="tabcontent">
            ...
            {isData ? <div className="usermanage">
                <div className="usermanage__userWrap">
                    <div className="usermanage__userWrapDetail">
                        ...
                        {/* <div className="usermanage__userWrap__subTitle">Muted</div> */}
                    </div>
                    ...
                    <div className="magicSearchFull">
                        <input type="text" id="myHouse2" name="myHouse2" className="magicSearchFull__search" placeholder="type here..." />
                        <img src="/images/search-field-icon.svg" className="magicSearchFull__icon" alt="" />
                        <div className="magicSearch__Boxlist magicSearch-display-none ul-box" id="resultMuted">
            ...
            </div> : <Empty heading='Muted' msg='No muted users in @Community name' imgSrc='banned_user_avex.svg' />}
        </div>
    )
}
