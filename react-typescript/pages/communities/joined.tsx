...
const BoardingJourCommunityJoined: React.FC = () => {
                ...
                <div className="enoch-community-deefi-signal">
                  ...
                  <div className="enoch-community-deefi-signal-right">
                    <ul className="community-deefi-signal-list">
                      ...
                      <li><button className="comuni-defiJoin-btn joined-clr">Joined</button></li>
...
export default BoardingJourCommunityJoined;
