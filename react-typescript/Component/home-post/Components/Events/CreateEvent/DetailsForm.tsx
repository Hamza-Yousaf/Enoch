...
const SpeakerOption = dynamic(() => import("./SpeakerOption"));
...
const DetailsForm = () => {
  ...
  const [showSpeakersToSelect, setShowSpeakersToSelect] = useState(false);
...
export default withApollo(DetailsForm, { getDataFromTree });
