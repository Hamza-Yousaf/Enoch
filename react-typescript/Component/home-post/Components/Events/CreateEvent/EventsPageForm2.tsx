...
const EventsPageForm2 = () => {
  ...
  const { currentEventCreationData } = bindActionCreators(
    actionCreators,
    dispatch
  );
  ...
  const handleRegistrationOrBroadcastLink = (e: any) => {
    setBroadcastLink(e.target.value);
  };
    ...
    createEventDateAndPlace({
      ...
      .then((resp) => {
        ...
        if (resp.data.createEventDateAndPlace.success === true) {
          nextStage("e");
          currentEventCreationData(resp.data.createEventDateAndPlace.event);
        } else {
          setShowAlert(true);
        ...
        <form>
          ...
          <div className="event-form-grp">
            ...
            <div className="eventLoc-block pb-1">
              ...
              >
                <div className="event-form-grp">
                  <div className="event-form-label">Event Broadcast Link</div>
                  <div className="event-form-inputbox">
                    <input
                      onChange={handleRegistrationOrBroadcastLink}
                      value={broadcastLink}
                      type="text"
                      placeholder="Event Broadcast Link"
                      name="broadcastLink"
                    />
                  </div>
                </div>
...
export default withApollo(EventsPageForm2, { getDataFromTree });
