...
const FAQSwap = () => {
  ...
  return (
    <div className="swap-faq-block">
      <h3 onClick={() => faqDropDownHandler(!faqDropDown)}>FAQs for Swap  </h3>
      <div id="trade-faq"
        className={classnames("trade-faq-drop", {
          show: faqDropDown == true,
        })}
      >
        <div className="trade-ask-ques" onClick={() => faqModelHandler(true)}>
          <button
            className="ask-ques-btn" data-toggle="modal" data-target="ques-modal">Ask a Question</button></div>
          ...
          <div id="ques-modal" className={classnames("modal fade", {
            ...
            <div className="modal-content ques-modal-content ">
              <span className="close"
                onClick={() => faqModelHandler(false)}
              ><img src="/images/Tclose.png" alt="close" className="img-fluid" data-dismiss="modal" /></span>
              <h4>Ask a Question</h4>
              <textarea className="ques-textarea" placeholder="Ask your questions"></textarea>
              <div className="mt-4"
                onClick={() => faqModelHandler(false)}
              ><button className="submit-ques-bttn">Submit your questions</button></div>
            </div>
          </div>
        </div>
