    ...
    <div className="trade-section1">
      <div className="trade-tabblock">
        <div className="trade-tabsection-lft">
            ...
            <ul>
              <li>
                <Link href="/trade/swap">
                  <button className="trade_tablinks active">
                    SWAP{" "}
                    <img
              ...
              <li>
                <Link href="/trade/liquidity">
                  <button className="trade_tablinks">
                    LIQUIDITY{" "}
                    <img
                      src="/images/info-icon.png"
                      className="img-fluid ml-2"
          ...
          <div className="trade-tabcontent-block">
            <div id="SWAP" className="trade_tabcontent trade-d-block">
              <div className="tarde-swap-block">
                <div className="tarde-swap-top">
                  <span className="swap-top-block1">
                    ...
                    <img
                      src="/images/swap-icon1.png"
                      className="img-fluid mr-2"
                      alt="icon"
                    />
                    56
                  </span>
                  <span className="liquidity-top-block2">
                    <div className="addEnoch-tooltip">
                      Add ENOCH to your metamask wallet
                    </div>{" "}
                    <img
                      src="/images/swap-icon2.png"
                      className="img-fluid"
                      alt="icon"
                    />
                  </span>
                ...
                <div className="swap-fromTo-block">
                  <div className="swap-from-block swap-from-topTip">
                    <p>
                      <span>Tip:</span> When you swap one token with another,
                      you make the trade in a decentralised manner. The Enoch
                      platform has no control over your assets and the trade is
                      carried out by preprogramed pieces of code.
                    </p>
                  </div>
                  <div className="swap-from-block">
                    <div className="swap-from-block-lft">
                      ...
                      <div className="trade-dropdown">
                        <a
                          ...
                          className="trade-input-box"
                          data-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="true"
                        >
                          <img
                            src="/images/trade-ether.png"
                            className="img-fluid mr-2"
                            alt="ether"
                          />
                          ETH
                        ...
                        <div
                          ...
                          className="dropdown-menu trade-input-dropbox-list"
                        >
                          <ul>
                            <li>
                              <span>
                    ...
                    <div className="swap-from-block-right">
                      ...
                      <div className="swap-balance-block">
                        Balance: 1.2 ETH
                        <span className="swap-balance-max">max</span>
                  ...
                  <div className="swap-from-to-val">
                    <ul>
                      <li>
                        <span>Enoch (ENOCH): $ 0.48</span>
                        <span>
                          <img
                            src="/images/tradePolygon1.png"
                            className="img-fluid"
                            alt="polygon"
                          />
                        </span>
                      ...
                      <li>
                        <span>Ether (ETH) : $ 2,459.23</span>
                        <span>
                          <img
                            src="/images/tradePolygon2.png"
                            className="img-fluid"
                            alt="polygon"
                          />
                        </span>
                  ...
                  <div className="trade-swap-btn-block">
                    <button className="swap-bttn">SWAP</button>
                  </div>
                </div>
              </div>
              <div className="tarde-swap-socialShare">
                <div className="swap-socialShare-bttn">
                  <span className="social-tradelike">
                    <img
                      src="/images/trade-like.png"
                      className="img-fluid mr-1 trade-like"
                      alt="icon"
                    />
                    <img
                      src="/images/trade-like-hov.png"
                      className="img-fluid mr-1 trade-like-hovr"
                      alt="icon"
                    />
                    516K
                  </span>
                  <span>
                    <img
                      src="/images/tradeshare-icon2.png"
                  ...
                  <span>
                    <img
                      src="/images/tradeshare-icon3.png"
                      className="img-fluid mr-1"
                      alt="icon"
                    />
                  </span>
      ...
      <div className="trade-adsection-right">
        <div className="trade-adsection-right-block1">
          <img
            src="/images/swap-banner-ad1.png"
            className="img-fluid"
            alt="icon"
          />
        ...
        <div className="trade-adsection-right-block5">
          <img
            src="/images/swap-banner-ad5.png"
            className="img-fluid"
            alt="icon"
          />
          <div className="ad-sponsored">
