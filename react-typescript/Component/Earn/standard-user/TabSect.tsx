...
const Affiliate = dynamic(() => import("./affiliate"));
        ...
        <div id="overview"
          ...
          <div className="earn-recent-income-sect">
            ...
            <div className="earn-pending-withdraw-sect">
              ...
              <div className="earn-pending-withdraw-right">
                <div className="pending-withdraw-recent-p0">
                  <span><img src="/images/Uriel.png" className="img-fluid" alt="icon" /></span>
                  <div className="pending-withdraw-p0-txt">
                    <h3>Uriel</h3>
                    <p>Total amount locked in bonuses  </p>
                  </div>
              ...
              <div className="earn-pending-withdraw-lft">
                <div className="pending-withdraw-recent-p0">
                  <span><img src="/images/gurdian.png" className="img-fluid" alt="icon" /></span>
                  <div className="pending-withdraw-p0-txt">
                    <h3>Guardian</h3>
                    <p>Total amount locked in bonuses  </p>
                  </div>
              ...
              <div className="earn-pending-withdraw-lft">
                <div className="pending-withdraw-recent-p0">
                  <span><img src="/images/enochshop.png" className="img-fluid" alt="icon" /></span>
                  <div className="pending-withdraw-p0-txt">
                    <h3>Enoch Shops</h3>
                    <p>Total amount locked in bonuses  </p>
                  </div>
              ...
              <div className="earn-pending-withdraw-right">
                <div className="pending-withdraw-recent-p0">
                  <span><img src="/images/livestream.png" className="img-fluid" alt="icon" /></span>
                  <div className="pending-withdraw-p0-txt">
                    <h3>Livezone</h3>
                    <p>Total amount locked in bonuses </p>
                  </div>
