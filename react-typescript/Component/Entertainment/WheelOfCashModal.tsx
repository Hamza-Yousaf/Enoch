...
const WheelOfCashModal: React.FC<Props> = ({
  showWheel,
  setShowWheel,
  setPrizeImage,
  setShowPrizeWon,
  ...
  return (
    <div className="spin-modal-block cash-modal-block">
      <div
        id="cash-modal1"
      ...
      >
        <div className="modal-content spin-modal-content">
          ...
          {/* <div className="wheel-btn-block">
            <button id="cash-btn" className="wheel-spin-button">
              <img
          ...
          <div id="cash-display" className="display2">
            -
          </div>
          <div className="clock">
            <p>Next free spin bonus</p>
            <div className="clock-timer">
              <label id="hour2">11</label>:<label id="minutes2">01</label>:
              <label id="seconds">43</label>
            </div>
          </div> */}
          {showSpinButton === true ? (
            <div className="wheel-btn-block">
...
export default WheelOfCashModal;
