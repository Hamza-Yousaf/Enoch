...
const SignInEmail: React.FC = () => {
  ...
  const { currentLoggedInUser } = bindActionCreators(actionCreators, dispatch);
  ...
  if (data) {
    ...
    currentLoggedInUser(data?.login?.user);
    const user = data?.login?.user;

    if (user?.completeOnboarding == false) {
              ...
              onSubmit={(values: MyFormValues, setSubmitting: any) => {
                signIn({
                  ...
                  .then((res) => {
                    ...
                    currentLoggedInUser(res?.data?.login?.user);
                    Cookie.set("loggedInUser", res?.data?.login?.user);
                  })
                  .catch((err) => {
                    console.log(err);
