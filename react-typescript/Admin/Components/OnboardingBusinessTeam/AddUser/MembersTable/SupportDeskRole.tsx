...
const SupportDeskRole = () => {
  ...
  return (
    <div className="roles_collaps-row roles_collaps-row-4">
      <button
        className={
          showOptions
      ...
      >
        ...
        >
          <img
            ...
            alt="down"
            className="img-fluid Sup-Admin-down-4"
          />
        </div>
      </button>
      <div
...
export default SupportDeskRole;
